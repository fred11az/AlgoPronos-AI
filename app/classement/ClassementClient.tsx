...
const BOOKMAKERS = [
  { name: 'Partenaire', url: process.env.NEXT_PUBLIC_1XBET_AFFILIATE_URL || 'https://refpa14435.com/L?tag=d_5346138m_1599c_&site=5346138&ad=1599', color: 'bg-primary/20 text-primary border-primary/30' },
