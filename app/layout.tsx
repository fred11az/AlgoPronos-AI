...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "AlgoPronos AI - Combinés Gagnants avec l'IA | 100% Gratuit",
    description: 'Plateforme gratuite de génération automatique de combinés de paris sportifs. 2 coupons IA par jour.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'AlgoPronos AI' }],
  },
  twitter: {
